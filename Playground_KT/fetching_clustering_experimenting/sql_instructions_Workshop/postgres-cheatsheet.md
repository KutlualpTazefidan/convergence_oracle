Short Notes:
- To change user between: 
  - sudo -u postgres psql -U postgres # This works (sudo -u postgres -i and su linuxuser after switching to postgres user type: psql) This puts you into the wrong folder
...
Use '' instead of "" if run a sql file

AWS:
- dont use snapshots
- create AWS account, use frankfurt
