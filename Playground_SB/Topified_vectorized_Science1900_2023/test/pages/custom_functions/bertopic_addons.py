...
def pull_local_sql_database():
    ...
    # Defining the Engine
    engine = sqlalchemy.create_engine('postgresql://convergence:sobrog-8tosPe-dusbyt@convergence-oracle.cpuph1fctgew.eu-central-1.rds.amazonaws.com:5432/postgres')
