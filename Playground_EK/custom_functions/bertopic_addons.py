...
def extract_topics_with_bertopic_eric(dataframe, min_topic_size, fine_tune_label, ngram):
    ...
    model, topics, proba, docs = extract_topics(dataframe, min_topic_size=min_topic_size, fine_tune_label=fine_tune_label, ngram=ngram)
    
    print("Step 7/7: Adding topic labels to the df ...")
    df = add_topic_labels(dataframe,topics,proba,model)
